...
const translations = {
  ...
  coming_subheadline: {
    ...
    bg: "Премиум уелнес придобивка, която зарежда екипа Ви, подкрепя българския бизнес и дарява за благотворителност — всеки месец."
  },
  coming_signup_title: {
  ...
  footer_description: {
    ...
    bg: "Премиум уелнес придобивки за съвременни компании. Здравословни продукти, местно производство, месечни дарения."
  },
  footer_quick_links: {
    en: "Quick Links",
    bg: "Бързи връзки"
  ...
  footer_rights: {
    en: "© 2026 Genki. All rights reserved.",
    bg: "© 2026 Genki. Всички права запазени."
  },
  footer_privacy: {
    en: "Privacy Policy",
  ...
  index_hero_subtitle: {
    ...
    bg: "Премиум уелнес придобивки, които служителите наистина обичат. Здравословни снаксове, напитки и храна, доставени до вашия офис — докато подкрепяте български бизнеси и благотворителност."
  },
  index_cta_book: {
    en: "Book a Free Call",
    bg: "Безплатен разговор"
  },
  index_cta_how: {
    en: "See How It Works",
    bg: "Вижте как работи"
  ...
  index_pillars_subtitle: {
    ...
    bg: "Всеки абонамент за Genki създава тройно въздействие — за вашия екип, за българските бизнеси и за нуждаещите се."
  },
  index_pillar1_title: {
  ...
  index_pillar1_desc: {
    ...
    bg: "Внимателно подбрана селекция от хранителни снаксове, органични напитки и балансирани ястия. Без преработена храна — само храна, която подхранва производителността."
  },
  index_pillar1_item1: {
  ...
  index_pillar2_desc: {
    ...
    bg: "100% от нашите продукти идват от местни български производители. Вашият абонамент директно подкрепя местната икономика."
  },
  index_pillar2_item1: {
  ...
  index_how_title: {
    ...
    bg: "Започването е лесно"
  },
  index_how_subtitle: {
    en: "We handle everything. You just approve the setup and watch employee satisfaction soar.",
    bg: "Ние се грижим за всичко. Вие просто одобрявате настройката и гледате как удовлетвореността на служителите расте."
  },
  index_step1_title: {
    en: "Book a Call",
    bg: "Запазете разговор"
  ...
  index_step2_desc: {
    ...
    bg: "Създаваме персонализирана продуктова комбинация според размера на екипа и предпочитанията."
  },
  index_step3_title: {
    en: "We Deliver",
    bg: "Ние доставяме"
  ...
  index_step3_desc: {
    en: "Regular deliveries straight to your office. No storage hassles.",
    bg: "Редовни доставки директно до вашия офис. Без проблеми със съхранението."
  },
  index_step4_title: {
    en: "Team Enjoys",
  ...
  index_hr_subtitle: {
    ...
    bg: "За разлика от сложните програми за придобивки, Genki не изисква администрация. Ние се грижим за всичко — от снабдяването до доставката и отчитането на въздействието."
  },
  ...
  index_hr_vendor_desc: {
    en: "One subscription, 50+ product partners handled by us.",
    bg: "Един абонамент, 50+ продуктови партньора, управлявани от нас."
  },
  index_hr_esg_title: {
  ...
  index_hr_esg_desc: {
    ...
    bg: "Вграденият благотворителен компонент подобрява вашите CSR отчети."
  },
  ...
  index_hr_card_desc: {
    ...
    bg: "Позиционирайте компанията си като лидер в уелнес с придобивка, която служителите използват всеки ден — не само когато отидат на фитнес."
  },
  index_hr_stat_desc: {
  ...
  companies_hero_subtitle: {
    ...
    bg: "Членството във фитнес остава неизползвано. Genki снаксовете се харесват всеки ден. Дайте на екипа си осезаема придобивка, която ще обикнат — без административна тежест."
  },
  companies_why_title: {
  ...
  companies_benefit2_desc: {
    ...
    bg: "Включено 10% благотворително дарение. Получете автоматично ESG въздействие за вашите отчети за устойчивост."
  },
  companies_benefit3_title: {
    en: "Boost Retention",
    bg: "Повишете задържането"
  },
  companies_benefit3_desc: {
    en: "Daily visible benefit that employees appreciate. Shows you care about their wellbeing.",
  ...
  companies_benefit5_desc: {
    ...
    bg: "Заменете вредната храна от автомати с хранителни опции. По-добър фокус, по-малко болнични."
  },
  ...
  companies_roi_recruiting_desc: {
    en: "Stand out in the competitive IT market with tangible, visible benefits candidates appreciate.",
    bg: "Отличете се на конкурентния IT пазар с осезаеми, видими придобивки, които кандидатите ценят."
  },
  companies_roi_calc_title: {
    en: "Sample ROI Calculation",
    bg: "Примерно изчисление на ROI"
  },
  companies_roi_team_size: {
    en: "Team size",
    bg: "Размер на екипа"
  },
  companies_roi_employees: {
    en: "employees",
    bg: "служители"
  },
  companies_roi_monthly: {
    en: "Monthly investment",
    bg: "Месечна инвестиция"
  },
  companies_roi_charity_donated: {
    en: "Charity donated (10%)",
    bg: "Дарено за благотворителност (10%)"
  },
  companies_roi_reduced: {
    en: "Reduced turnover (est. 2 employees/year)",
    bg: "Намалено текучество (прибл. 2 служители/година)"
  },
  companies_roi_saved: {
    en: "saved",
    bg: "спестени"
  ...
  companies_roi_disclaimer: {
    en: "*Based on industry averages. Your results may vary.",
  ...
  companies_faq2_a: {
    ...
    bg: "Доставяме директно до вашия офис по график (седмично или на две седмици в зависимост от плана). Не е необходимо съхранение — доставяме точно това, от което екипът ви се нуждае."
  },
  companies_faq3_q: {
  ...
  companies_faq3_a: {
    ...
    bg: "Абсолютно. Предлагаме вегетариански, веган, безглутенови и други диетични опции. Просто ни кажете изискванията на вашия екип."
  },
  companies_faq4_q: {
  ...
  companies_faq5_q: {
    ...
    bg: "Каква е продължителността на договора?"
  },
  companies_faq5_a: {
  ...
  mission_name_culture: {
    ...
    bg: 'В японската култура въпросът "Genki desu ka?" (Genki ли си?) е начин да попиташ "Как си?" — но е по-дълбоко от това. Пита се за цялостната ти жизненост, дух и благополучие.'
  },
  mission_name_wish: {
  ...
  products_snacks_subtitle: {
    en: "Energy-boosting options for any time of day",
    bg: "Енергизиращи опции за всяко време на деня"
  },
  products_snacks_desc: {
    en: "Energy-boosting options for any time of day",
    bg: "Енергизиращи опции за всяко време на деня"
  },
  products_drinks_title: {
    en: "Beverages",
    bg: "Напитки"
  },
  products_drinks_subtitle: {
  ...
  products_meals_note: {
    ...
    bg: "Достъпно в Професионален и Корпоративен план"
  },
  products_badge_bio: {
    en: "Bio",
    bg: "Био"
  },
  products_badge_natural: {
    en: "Natural",
    bg: "Натурален"
  },
  ...
  products_badge_lowcal: {
    en: "Low Calorie",
    bg: "Нискокалоричен"
  },
  products_badge_local: {
    en: "Local",
    bg: "Местен"
  },
  products_badge_fresh: {
    en: "Fresh Pressed",
    bg: "Прясно изцеден"
  },
  ...
  products_badge_seasonal: {
    en: "Seasonal",
    bg: "Сезонен"
  },
  products_badge_healthy: {
    en: "Healthy",
    bg: "Здравословен"
  },
  ...
  products_badge_balanced: {
    en: "Balanced",
    bg: "Балансиран"
  },
  products_badge_nosugar: {
    en: "No Sugar",
    bg: "Без захар"
  },
  ...
  products_nuts_desc: {
    en: "Bulgarian almonds, walnuts & hazelnuts",
    bg: "Български бадеми, орехи и лешници"
  },
  products_dried_title: {
    en: "Dried Fruits",
    bg: "Сушени плодове"
  },
  products_dried_desc: {
    en: "Apricots, figs & prunes from Plovdiv region",
    bg: "Кайсии, смокини и сливи от Пловдивски регион"
  },
  products_bars_title: {
    en: "Protein Bars",
  ...
  products_rice_desc: {
    ...
    bg: "Пълнозърнести, различни вкусове"
  },
  products_seeds_title: {
    en: "Seed Mix",
    bg: "Микс от семена"
  },
  products_seeds_desc: {
    en: "Sunflower, pumpkin & chia seeds",
    bg: "Слънчогледови, тиквени и чиа семена"
  },
  ...
  products_tea_desc: {
    en: "Bulgarian mountain herbs & flowers",
    bg: "Български планински билки и цветя"
  },
  products_kombucha_title: {
    en: "Kombucha",
    bg: "Комбуча"
  },
  ...
  products_water_title: {
    en: "Mineral Water",
    bg: "Минерална вода"
  },
  products_water_desc: {
    en: "From Bulgarian mountain springs",
    bg: "От български планински извори"
  },
  products_smoothie_title: {
    en: "Smoothies",
    bg: "Смутита"
  },
  products_smoothie_desc: {
    en: "Fruit & vegetable blends",
    bg: "Плодови и зеленчукови смеси"
  },
  products_berrydrink_title: {
    en: "Berry Drinks",
    bg: "Напитки от горски плодове"
  },
  products_berrydrink_desc: {
    en: "Blueberry, aronia & elderberry",
    bg: "Боровинка, арония и бъз"
  },
  products_cheese_title: {
    en: "Bulgarian Cheese",
    bg: "Българско сирене"
  },
  products_cheese_desc: {
    en: "White cheese, kashkaval & cottage cheese",
    bg: "Бяло сирене, кашкавал и извара"
  },
  products_fruits_title: {
    en: "Fresh Fruits",
    bg: "Пресни плодове"
  },
  products_fruits_desc: {
    en: "Seasonal selection from Bulgarian farms",
    bg: "Сезонна селекция от български ферми"
  },
  products_yogurt_title: {
    en: "Bulgarian Yogurt",
    bg: "Българско кисело мляко"
  },
  products_yogurt_desc: {
    en: "Traditional recipe with live cultures",
    bg: "Традиционна рецепта с живи култури"
  },
  products_veggie_title: {
    en: "Veggie Sticks",
    bg: "Зеленчукови пръчици"
  },
  products_veggie_desc: {
  ...
  products_cta_desc: {
    ...
    bg: "Запазете разговор и ще създадем персонализирана продуктова селекция според предпочитанията на вашия екип."
  },
  products_cta_button: {
    en: "Request Full Catalog",
    bg: "Заявете пълен каталог"
  },
  products_mixed_nuts: {
    en: "Mixed Nuts",
    bg: "Смесени ядки"
  },
  products_mixed_nuts_desc: {
    en: "Bulgarian almonds, walnuts & hazelnuts",
    bg: "Български бадеми, орехи и лешници"
  },
  products_dried_fruits: {
    en: "Dried Fruits",
    bg: "Сушени плодове"
  },
  products_dried_fruits_desc: {
    en: "Apricots, figs & prunes from Plovdiv region",
    bg: "Кайсии, смокини и сливи от Пловдивски регион"
  },
  products_protein_bars: {
    en: "Protein Bars",
    bg: "Протеинови барове"
  },
  ...
  products_smoothies_desc: {
    en: "Fruit & vegetable blends",
    bg: "Плодови и зеленчукови смеси"
  },
  products_berry_drinks: {
    en: "Berry Drinks",
    bg: "Напитки от горски плодове"
  },
  products_berry_drinks_desc: {
    en: "Blueberry, aronia & elderberry",
    bg: "Боровинка, арония и бъз"
  },
  products_bulgarian_cheese: {
    en: "Bulgarian Cheese",
    bg: "Българско сирене"
  },
  products_bulgarian_cheese_desc: {
    en: "White cheese, kashkaval & cottage cheese",
    bg: "Бяло сирене, кашкавал и извара"
  },
  products_fresh_fruits: {
    en: "Fresh Fruits",
    bg: "Пресни плодове"
  },
  products_fresh_fruits_desc: {
    en: "Seasonal selection from Bulgarian farms",
    bg: "Сезонна селекция от български ферми"
  },
  products_bulgarian_yogurt: {
    en: "Bulgarian Yogurt",
    bg: "Българско кисело мляко"
  },
  products_bulgarian_yogurt_desc: {
    en: "Traditional recipe with live cultures",
    bg: "Традиционна рецепта с живи култури"
  },
  products_veggie_sticks: {
    en: "Veggie Sticks",
    bg: "Зеленчукови пръчици"
  },
  products_veggie_sticks_desc: {
    en: "Carrots, cucumbers & peppers with hummus",
    bg: "Моркови, краставици и чушки с хумус"
  },
  ...
  contact_hero_subtitle: {
    ...
    bg: "Запазете безплатен разговор и открийте как Genki може да трансформира придобивките на служителите ви, докато подкрепя местни бизнеси и благотворителност."
  },
  contact_form_title: {
    en: "Book a Free Call",
    bg: "Запазете безплатен разговор"
  ...
  contact_size_200: {
    en: "200-500 employees",
    bg: "200-500 служители"
  },
  contact_size_500: {
    en: "500-1000 employees",
    bg: "500-1000 служители"
  },
  contact_size_1000: {
    en: "1000+ employees",
    bg: "1000+ служители"
  ...
  contact_message_placeholder: {
    ...
    bg: "Разкажете ни за екипа си, диетични изисквания или специфични нужди..."
  },
  contact_submit: {
    en: "Request a Call",
    bg: "Заявете обаждане"
  ...
  contact_response_time: {
    ...
    bg: "Ще се свържем с вас в рамките на 24 часа."
  },
  contact_response: {
    en: "We'll get back to you within 24 hours.",
    bg: "Ще се свържем с вас в рамките на 24 часа."
  },
  contact_expect_title: {
    en: "What to Expect",
    bg: "Какво да очаквате"
  },
  contact_expect1_title: {
    en: "Quick Discovery Call",
  ...
  contact_expect2_title: {
    en: "Custom Proposal",
    bg: "Персонализирана оферта"
  },
  contact_step2_title: {
    en: "Custom Proposal",
    bg: "Персонализирана оферта"
  },
  contact_expect2_desc: {
    en: "We'll create a tailored product mix and pricing for your team.",
  ...
  contact_direct_title: {
    ...
    bg: "Предпочитате директен контакт?"
  },
  contact_email_us: {
    en: "Email us",
    bg: "Пишете ни"
  ...
  contact_faq1_q: {
    en: "Is there a minimum commitment period?",
    bg: "Има ли минимален период на ангажимент?"
  },
  contact_faq1_a: {
    en: "We offer flexible 3-month, 6-month, or annual contracts. You can start with a 3-month pilot to test with your team.",
    bg: "Предлагаме гъвкави 3-месечни, 6-месечни или годишни договори. Можете да започнете с 3-месечен пилотен период, за да тествате с екипа си."
  },
  contact_faq2_q: {
  ...
  contact_faq2_a: {
    en: "Once you approve the proposal, we can have your first delivery within a week. Setup is completely hassle-free for your team.",
    bg: "След като одобрите офертата, можем да направим първата доставка в рамките на седмица. Настройката е напълно безпроблемна за вашия екип."
  },
  contact_faq3_q: {
    en: "Do you deliver outside Sofia?",
    bg: "Доставяте ли извън София?"
  },
  contact_faq3_a: {
    en: "Yes! We deliver to major cities across Bulgaria including Plovdiv, Varna, Burgas, and more. Contact us for specific availability.",
    bg: "Да! Доставяме до големите градове в България, включително Пловдив, Варна, Бургас и други. Свържете се с нас за конкретна наличност."
  },
  contact_faq4_q: {
  ...
  contact_faq4_a: {
    ...
    bg: "Абсолютно. Ще работим с вас, за да създадем микс, който отговаря на предпочитанията на екипа ви, диетичните нужди и бюджета."
  },
  contact_message_placeholder: {
    en: "Tell us about your team, any dietary requirements, or specific needs...",
    bg: "Разкажете ни за екипа си, диетични изисквания или специфични нужди..."
  ...
  form_success: {
    ...
    bg: "Благодарим ви! Ще се свържем с вас в рамките на 24 часа."
  }
};
...
function setLanguage(lang) {
  currentLang = lang;
  localStorage.setItem('genki-lang', lang);
...
function updateContent() {
  ...
  if (titleKey && translations[titleKey]) {
    document.title = translations[titleKey][currentLang];
  }
}
...
function updateLangSwitcher() {
  ...
  document.querySelectorAll('.lang-option').forEach(opt => {
    if (opt.getAttribute('data-lang') === currentLang) {
      opt.classList.add('bg-primary-50', 'text-primary-700');
    } else {
