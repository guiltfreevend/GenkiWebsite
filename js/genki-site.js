...
(function (global) {
  ...
  /* ======================================================================
     ...
     ====================================================================== */
  var SLOTS = {
    /* Стойностите идват от docs/GENKI-2.0-VISUAL-ASSET-PRODUCTION-PLAN.md —
       каноничният източник за производствените активи. Където планът не
       дава размер по слот, важи класът от docs/GENKI-2.0-ASSETS.md.
       Всяка двойка е сверена със съотношението си. */
    ...
    /* --- Начало ------------------------------------------------------ */
    H01: { d: '4/5',    m: '3/4',    file: '2400×3000', mfile: '1500×2000',
           css: '643×804', mcss: '332×443',
           tone: 'brand', role: 'Genki машината в офис кухня, заредена' },
    H05: { d: '4/3',    m: '4/5',    file: '2000×1500', mfile: '1400×1750',
           css: '624×468', mcss: '332×415',
           tone: 'cream', role: 'Български продукти на светла повърхност' },

    /* --- За компании -------------------------------------------------- */
    C01: { d: '2/1',    m: '4/5',    file: '3840×1920', mfile: '1400×1750',
           css: '1279×640', mcss: '332×415',
           tone: 'brand', role: 'Машината в ежедневието на офиса' },
    C02: { d: '4/3',    m: '4/5',    file: '2000×1500', mfile: '1400×1750',
           css: '624×468', mcss: '332×415',
           tone: 'cream', role: 'Зареждане на рафт — операцията' },
    C05: { d: '16/9',   m: '3/2',    file: '2000×1125', mfile: '1400×933',
           css: '514×289', mcss: '332×221',
           tone: 'cream', role: 'Genki до кафемашина и купа с плодове' },

    /* --- Как работи Genki --------------------------------------------- */
    W01: { d: '3/4',    m: '4/5',    file: '1600×2133', mfile: '1400×1750',
           css: '416×555', mcss: '332×415',
           tone: 'brand', role: 'Портрет на машината, фронтално' },
    W02: { d: '1/1',    m: '1/1',    file: '1600×1600', mfile: '1600×1600',
           css: '296×296', mcss: '332×332',
           tone: 'cream', role: 'Карта до четеца NEXGO UN20' },
    W03: { d: '1/1',    m: '1/1',    file: '1600×1600', mfile: '1600×1600',
           css: '296×296', mcss: '332×332',
           tone: 'cream', role: 'Ръка взема продукт от рафта' },
    W04: { d: '1/1',    m: '1/1',    file: '1600×1600', mfile: '1600×1600',
           css: '296×296', mcss: '332×332',
           tone: 'cream', role: 'Затваряне / завършена покупка' },
    W05: { d: '4/3',    m: '4/5',    file: '1600×1200', mfile: '1400×1750',
           css: '624×468', mcss: '332×415',
           tone: 'cream', role: 'Зад кулисите — подготовка за зареждане' },

    /* --- Мисия и въздействие ------------------------------------------ */
    M01: { d: '3/2',    m: '4/5',    file: '2400×1600', mfile: '1400×1750',
           css: '733×489', mcss: '332×415',
           tone: 'cream', role: 'Обикновен момент в офиса' },
    M02: { d: '4/3',    m: '4/5',    file: '1600×1200', mfile: '1400×1750',
           css: '514×386', mcss: '332×415',
           tone: 'cream', role: 'Близък кадър — Genki Product Standard' },
    M03: { d: '4/3',    m: '4/5',    file: '1600×1200', mfile: '1400×1750',
           css: '514×386', mcss: '332×415',
           tone: 'cream', role: 'Български производител' },
    M05: { d: '3/2',    m: '3/2',    file: '1600×1067', mfile: '1200×800',
           css: '514×343', mcss: '332×221',
           tone: 'cream', role: 'Доброволческа инициатива — чака реално събитие' },

    /* --- Genki Fit ---------------------------------------------------- */
    F08: { d: '3/2',    m: '3/2',    file: '1200×800',  mfile: '1200×800',
           tone: 'cream', role: 'Препоръчаният хардуер в резултата' },
  };
