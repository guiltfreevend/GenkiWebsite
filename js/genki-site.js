...
(function (global) {
  ...
  var SLOTS = {
    ...
    /* Каноничната карта в „WEBSITE COPY & HANDOFF" дава W05 = Зад кулисите,
       W06 = Price Support, W07 = Genki се учи. Тук стои каноничният ID. */
    ...
    /* M05 чака реална снимка от инициатива, която вече се е случила.
       До тогава placeholder — нищо не се представя като документ за
       минало събитие на Genki. */
